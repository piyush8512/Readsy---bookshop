        ...
        <div className="w-full max-w-8xl  overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="md:w-1/3 p-8 md:p-12 border-l-2 border-gray-500">
            ...
            <div className="space-y-4 mb-3">
              <button className="w-full flex items-center justify-center py-5 px-4 border-2 border-gray-600  text-sm font-medium text-gray-700  hover:bg-orange-400 hover:text-white hover:cursor-pointer">
                <svg
